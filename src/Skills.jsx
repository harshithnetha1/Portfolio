...
export default function Skills() {
  ...
  return (
    ...
    I have been a front end developer for the past few years, working on various projects.
     I am currently adding MERN full stack skills to my toolkit and have completed several personal projects.
      ...
      <span style={{color:'white',padding:'20px', fontSize:'30px'}}>
      With a robust 4+ years in front-end development, I have successfully contributed to various projects, showcasing my expertise in creating dynamic and user-friendly web applications. My journey as a developer has been marked by a dedication to continuous learning and skill enhancement.
      </span>
      <div className='developer-text'>
